...
CREATE USER 'dotrohoni'@'localhost' IDENTIFIED BY 'dotrohoni';
GRANT USAGE ON * . * TO  'dotrohoni'@'localhost' IDENTIFIED 'dotrohoni' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0 ;
GRANT ALL PRIVILEGES ON  `dotrohoni` . * TO  'dotrohoni'@'localhost';
SHOW WARNINGS;
